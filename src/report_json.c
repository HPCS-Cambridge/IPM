...
void json_env(void *ptr, taskdata_t *t)
{
...
void json_internal(void *ptr, taskdata_t *t)
{
  //todo
}
...
void json_ptrtable(void *ptr, taskdata_t *t)
{
  // TODO
}
...
void json_hash(void *ptr, taskdata_t *t, ipm_hent_t *htab)
{
  int i, j;
  int slct, call, bytes, reg, csite;
  int op, dtype;
